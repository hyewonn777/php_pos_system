...
<body>
  ...
  <div class="content">
    ...
    <!-- CSV Import Form -->
    <form action="stock.php" method="POST" enctype="multipart/form-data" style="margin-top:20px; padding:15px; background:var(--card-bg); border-radius:8px;">
      <h4>Import products from CSV</h4>
      <input type="file" name="csv_file" accept=".csv" required>
      <button type="submit" name="import_csv" style="margin-left:8px; padding:8px 12px; background:#3498db; color:#fff; border:none; border-radius:6px; cursor:pointer;">Upload CSV</button>
      <div class="small" style="margin-top:6px; color:#666;">CSV columns: Category, Name, Price, Image (Image optional)</div>
    </form>

    <!-- Template Generator -->
    <form action="stock.php" method="POST" style="margin-top:12px;">
      <button type="submit" name="generate_template" style="padding:8px 12px; background:#27ae60; color:#fff; border:none; border-radius:6px; cursor:pointer;">Download CSV Template</button>
    </form>
