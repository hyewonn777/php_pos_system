...
<form id="productForm" enctype="multipart/form-data" method="POST" 
      style="padding:12px; background:var(--card-bg); border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.04); margin-bottom:16px;">
...
<!-- CSV Tools -->
<div class="csv-tools" style="margin-bottom:16px;">
